// User data (you can replace this with server-side authentication)
const users = {
    LQ1: { password: '100100', allowedIcons: ['icon1Container', 'icon2Container', 'icon3Container', 'icon4Container', 'icon5Container', 'icon6Container', 'icon7Container', 'icon8Container', 'icon9Container', 'icon10Container', 'icon11Container', 'icon12Container', 'icon13Container', 'icon14Container'] },
    genuser: { password: 'dhl123!', allowedIcons: ['icon1Container', 'icon2Container', 'icon3Container', 'icon4Container', 'icon5Container', 'icon6Container', 'icon7Container', 'icon8Container', 'icon9Container', 'icon10Container', 'icon11Container', 'icon12Container', 'icon13Container'] }, // 'icon14Container' is removed for genuser
    managersdhl: { password: 'manager123!', allowedIcons: ['icon1Container', 'icon2Container', 'icon3Container', 'icon4Container', 'icon5Container', 'icon6Container', 'icon7Container', 'icon8Container', 'icon9Container', 'icon10Container', 'icon11Container', 'icon12Container', 'icon13Container', 'icon14Container'] } // 'icon14Container' is removed for user2
};
...
function checkLogin(username, password) {
    if (users[username] && users[username].password === password) {
        return users[username].allowedIcons;
    } else {
        return false;
    }
}

// Function to load the application for the user
function loadApplication(username) {
    const allowedIcons = users[username].allowedIcons;

    document.getElementById('loginForm').style.display = 'none';
    document.querySelector('.main-container').style.display = 'block';

    // Hide all icons initially
    document.querySelectorAll('.icon-label').forEach(icon => {
        icon.style.display = 'none';
    });

    // Show only allowed icons
    allowedIcons.forEach(iconId => {
...
document.getElementById('loginButton').addEventListener('click', function() {
    ...
    const allowedIcons = checkLogin(username, password);
...
//                 b.innerHTML += "<input type='hidden' value='" + arr[i].name + "' data-code='" + arr[i].dial_code + "'>";
//                 b.addEventListener("click", function(e) {
//                     inp.value = this.getElementsByTagName("input")[0].value;
//                     document.getElementById('countryCode').value = this.getElementsByTagName("input")[0].getAttribute("data-code");
//                     closeAllLists();
//                 });
//                 a.appendChild(b);
//             }
...
// Ensure the autocomplete items adopt the correct mode style when created
function autocomplete(inp, arr) {
    let currentFocus;
...
document.getElementById('icon1').addEventListener('click', function() {
    window.open('https://shipnow.dhl.com/pwa-ui/get-a-quote', '_blank');
});

document.getElementById('icon2').addEventListener('click', function() {
    window.open('https://israelpost.co.il/%D7%A9%D7%99%D7%A8%D7%95%D7%AA%D7%99%D7%9D/%D7%90%D7%99%D7%AA%D7%95%D7%A8-%D7%9E%D7%99%D7%A7%D7%95%D7%93/', '_blank');
});

document.getElementById('icon3').addEventListener('click', function() {
    window.open('https://members.dundb.co.il/', '_blank');
});

document.getElementById('icon4').addEventListener('click', function() {
    window.open('https://dhl.lighthouse-cloud.com/kms/CM/INTERNAL/LAYOUT?item_id=5&homePage=/CM/HOMEPAGE/VIEW?layoutId=5', '_blank');
});

document.getElementById('icon5').addEventListener('click', function() {
    window.open('https://sherloc.dhl.com/#/login', '_blank');
});
...
document.getElementById('icon7').addEventListener('click', function() {
    window.open('https://connect.dpdhl.com/content/page/5f7ec07fd6f7f864d9bc9279', '_blank');
});

document.getElementById('icon8').addEventListener('click', function() {
    window.open('https://comet.dhl.com/siebel/app/sales/heb?SWECmd=Login&SWECM=S&SWEHo=comet.dhl.com', '_blank');
});
