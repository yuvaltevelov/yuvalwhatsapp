...
const users = {
    user1: { password: 'password1', allowedIcons: ['icon1Container', 'icon2Container', 'icon3Container', 'icon4Container', 'icon5Container', 'icon6Container', 'icon7Container', 'icon8Container', 'icon9Container', 'icon10Container', 'icon11Container', 'icon12Container', 'icon13Container', 'icon14Container'] },
    user2: { password: 'password2', allowedIcons: ['icon1Container', 'icon2Container', 'icon3Container', 'icon4Container', 'icon5Container', 'icon6Container', 'icon7Container', 'icon8Container', 'icon9Container', 'icon10Container', 'icon11Container', 'icon12Container', 'icon13Container'] } // 'icon14Container' is removed for user2
};
